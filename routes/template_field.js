...
router.get('/:uuid/draft_existing', getUserFromToken, validateUuid, templateFieldController.draft_existing);
router.get('/:uuid/latest_persisted', getUserFromToken, validateUuid, templateFieldController.get_latest_persisted);
